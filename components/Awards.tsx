        ...
        <div className="div-3 overflow-hidden pt-28 w-full">
          ...
          <div className="max-w-[100%] flex flex-row pt-10 gap-6 justify-around px-5">
            <div className="flex flex-col w-fit -space-y-10 items-center">
              ...
              <h1 className="text-[90px] text-white font-neutraface">12</h1>
            </div>
            ...
            <div className="flex flex-col w-fit -space-y-10 items-center">
              ...
              <h1 className="text-[90px] text-white font-neutraface">14</h1>
            </div>
            ...
            <div className="flex flex-col w-fit -space-y-10 items-center">
              ...
              <h1 className="text-[90px] text-white font-neutraface">50</h1>
            </div>
          </div>
        </div>
      </div>
